...
iphone=open('D:\python_midterm\status\iphone.txt','r')
samsung=open('D:\python_midterm\status\samsung.txt','r')
lumia=open('D:\python_midterm\status\lumia.txt','r')
ios=open('D:\python_midterm\status\ios.txt','r')
android=open('D:\python_midterm\status\\android.txt','r')
windowsphone=open('D:\python_midterm\status\windowsphone.txt','r')
