...
ph_fpositive=open('keyword\positive.txt','r')
ph_positive=[line.strip() for line in ph_fpositive]
ph_fnegative=open('keyword\\negative.txt','r')
ph_negative=[line.strip() for line in ph_fnegative]

sys_fpositive=open('keyword\system_positive.txt','r')
sys_positive=[line.strip() for line in sys_fpositive]
sys_fnegative=open('keyword\system_negative.txt','r')
sys_negative=[line.strip() for line in sys_fnegative]

iphone=open('D:\python_midterm\getproducttweets\\tweets\iphone.txt','r')
samsung=open('D:\python_midterm\getproducttweets\\tweets\samsung.txt','r')
lumia=open('D:\python_midterm\getproducttweets\\tweets\lumia.txt','r')
ios=open('D:\python_midterm\getproducttweets\\tweets\ios.txt','r')
android=open('D:\python_midterm\getproducttweets\\tweets\\android.txt','r')
windowsphone=open('D:\python_midterm\getproducttweets\\tweets\windowsphone.txt','r')
